                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                                                    <div class="card-grid-2 hover-up">
                                                        ...
                                                        <div class="card-block-info">
                                                            <h6><a href="offer-details.html">UI / UX Designer fulltime</a></h6>
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                                                    <div class="card-grid-2 hover-up">
                                                        ...
                                                        <div class="card-block-info">
                                                            <h6><a href="offer-details.html">Full Stack Engineer</a></h6>
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                                                    <div class="card-grid-2 hover-up">
                                                        ...
                                                        <div class="card-block-info">
                                                            <h6><a href="offer-details.html">Java Software Engineer</a></h6>
                                                            <div class="mt-5"><span class="card-briefcase">Full time</span><span class="card-time">6<span> minutes ago</span></span></div>
                                                            <p class="font-sm color-text-paragraph mt-15">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae architecto eveniet, dolor quo repellendus pariatur.</p>
                                                            <div class="mt-30"><a class="btn btn-grey-small mr-5" href="offer-details.html">Python</a><a class="btn btn-grey-small mr-5" href="offer-details.html">AWS</a><a class="btn btn-grey-small mr-5" href="offer-details.html">Photoshop</a>
                                                            </div>
                                                            <div class="card-2-bottom mt-30">
                                                                <div class="row">
