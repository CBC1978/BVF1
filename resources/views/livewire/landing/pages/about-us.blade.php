...
<section class="section">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="about-img">
          <img src="{{('landing/images/about/about.jpg')}}" class="img-fluid w-100 rounded" alt="">
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-sm-6">
        <div class="card my-3 my-lg-0">
          <img class="card-img-top" src="{{('landing/images/team/team1.jpg')}}" class="img-fluid w-100" alt="Card image cap">
