		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>Bourse Virtuel de Fret du Burkina Faso </h1>
					<p>Rejouins le plus grand marchés de fret <br> Ameliorer vos lorem ipsum et faites lorem ipsum</p>
							...
							<div class="col-lg-12 col-md-12 align-content-center">
								<form>
									<div class="form-row">
										...
										<div class="form-group col-lg-3 col-md-6">
											<input type="text" class="form-control my-2 my-lg-1" id="inputLocation4" placeholder="Lorem">
										</div>
